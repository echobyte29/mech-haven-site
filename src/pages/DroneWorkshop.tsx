        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              An advanced workshop on drone prototyping featuring expert insights from industry leaders and hands-on drone assembly and flight testing.
            </p>

            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <Calendar className="h-8 w-8 text-tech-cyan mx-auto mb-2" />
                <div className="text-lg font-semibold text-foreground">9th Jan 2025</div>
